...
const config: Config = {
  title: 'Welcome to Mainzelliste Docs | Mainzelliste Documentation',
  tagline: 'Mainzelliste Documentation',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://medicalinformatics.github.io/',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/mainzelliste.de/docs',
