...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-10 pt-[120px] dark:bg-gray-dark md:pb-10 md:pt-[150px] xl:pb-10 xl:pt-[180px] 2xl:pb-10 2xl:pt-[210px]"
      >
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#2a4ea3" />
                <stop offset="1" stopColor="#2a4ea3" stopOpacity="0" />
              </linearGradient>
              <radialGradient
              ...
              >
                <stop offset="0.145833" stopColor="#2a4ea3" stopOpacity="0" />
                <stop offset="1" stopColor="#2a4ea3" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2a4ea3" stopOpacity="0" />
                <stop offset="1" stopColor="#2a4ea3" />
              </linearGradient>
              <linearGradient
