  ...
  return (
    <>
      <a
        ...
        className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light dark:text-body-color-dark text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary sm:ml-3"
      >
        <svg
          width="16"
          height="16"
      ...
      <a
        href="#0"
        aria-label="social-share"
        className="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light dark:text-body-color-dark text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary"
      >
        <svg
          width="18"
          height="18"
