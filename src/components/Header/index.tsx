...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        setNavbarOpen(false);
        navbarTogglerRef.current?.focus();
      }
    };
  ...
  // Activate a scroll link via keyboard (Enter / Space)
              ...
              <div className="flex w-full items-center justify-between px-4">
                    ...
                    <ul className="block lg:flex lg:space-x-12">
                      {menuData.map((menuItem, index) => (
                          <li key={index} className="group relative">
                            <ScrollLink
                                ...
                                className="flex py-2 text-lg lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 transition-transform cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                            >
                              {menuItem.title}
                            </ScrollLink>
                          </li>
                      ...
                      <li key={menuData.length} className="group relative">
                        <Link
                            ...
                            href="/api-doc"
                            target="_blank"
                            className="flex items-center py-2 text-lg lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 transition-transform cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                ...
                <div className="items-center flex mb-2 pl-4 pr-16">
                  <a
                      ...
                      className="dark:text-body-color-dark mr-3 text-body-color duration-300 hover:text-primary dark:hover:text-primary rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  >
                    <Image
                        className="block"
